...
class TitleState extends MusicBeatState
{
	...
	var tapeBG:FlxSprite; //Added
	var tapeFG:FlxSprite; //Added
	...
	function startIntro()
	{
		...
		//Added
		tapeBG = new FlxSprite(0, 0).loadGraphic(Paths.image('tapeBG'));
		tapeBG.frames = Paths.getSparrowAtlas('tapeBG');
		tapeBG.animation.addByPrefix('reel', 'tapeREEL0', 24, false);
		tapeBG.animation.play('reel');


		//Added
		tapeFG = new FlxSprite(0, 420).loadGraphic(Paths.image('tapeFG'));
		tapeFG.frames = Paths.getSparrowAtlas('tapeFG');
		tapeFG.animation.addByPrefix('reel', 'tapeREEL0', 24, false);
		tapeFG.animation.play('reel');
	...
	override function beatHit()
	{
		...
		//Added
		if(tapeFG != null)
			tapeFG.animation.play('reel', true);
		
		if(tapeBG != null)
			tapeBG.animation.play('reel', true);
