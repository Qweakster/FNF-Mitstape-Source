...
class PlayState extends MusicBeatState
{
	...
	public function triggerEventNote(eventName:String, value1:String, value2:String) {
		switch(eventName) {
			...
			case 'Alex Enter':
				var alex = new FlxSprite(400, 800).loadGraphic(Paths.image('alex'));
				alex.screenCenter;
				alex.scale.set(1.8, 1.8); 
				alex.antialiasing = ClientPrefs.globalAntialiasing;
				add(alex);
				FlxTween.tween(alex, {x: 400, y: 100}, 3);
		}
